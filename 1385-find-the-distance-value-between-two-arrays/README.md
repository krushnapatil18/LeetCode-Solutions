<h2><a href="https://leetcode.com/problems/find-the-distance-value-between-two-arrays/?envType=problem-list-v2&envId=binary-search">1385. Find the Distance Value Between Two Arrays</a></h2><h3>Easy</h3><hr><p>Given two integer arrays <code>arr1</code> and <code>arr2</code>, and the integer <code>d</code>, <em>return the distance value between the two arrays</em>.</p>
